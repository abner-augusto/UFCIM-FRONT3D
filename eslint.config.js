...
export default tseslint.config(
  ...
  // src/components/ui/ is vendored shadcn-vue code (generated by the CLI).
  // Single-word component names (Button, Input, Card…) are the library's
  // convention — don't lint them against our app-code naming rules.
  {
