...
Usuários de teste: `{role}@teste.com` / `senha123456` (aluno, professor, manutencao).
...
Sem usuário de teste para `staff`/`admin`; cobertura via professor + manutenção + aluno cobre todas as permissões exceto `CAN_ADMIN`.
